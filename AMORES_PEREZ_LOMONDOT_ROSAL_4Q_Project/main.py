...
def init_db():
    """Initializes the database and table according to the rubrics."""
...
def add_student():
    ...
    color = validate_input(r"^(Red|Yellow|Green|Blue)$", "League Color (Red, Yellow, Green, Blue): ", "Invalid league color.")
...
def update_student():
    """Allows updating contact info while keeping Student ID fixed[cite: 1]."""
...
def delete_student():
    """Removes a student record based on ID[cite: 1]."""
